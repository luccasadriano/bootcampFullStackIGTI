...
function renderFavorites(){
   ...
   favoriteCountries.forEach(country => {
      ...
      const favoriteCountryHTML = `
         ...
         `
      favoritesHMTL += favoriteCountryHTML
   })

   favoritesHMTL += '</div>'
   tabFavorites.innerHTML = favoritesHMTL
}
...
function handleCountryButtons(){
   const countryButtons = Array.from(tabCountries.querySelectorAll('.btn'))//array.from convertendo para uma nodelist para array
